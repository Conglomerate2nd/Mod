...
idCVar pm_thirdPerson(				"pm_thirdPerson",			"1",			CVAR_GAME | CVAR_BOOL, "enables third person view" );//default 0
idCVar pm_thirdPersonDeath(			"pm_thirdPersonDeath",		"1",			CVAR_GAME | CVAR_BOOL, "enables third person view when player dies" );//default 0
